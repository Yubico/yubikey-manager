...
==== Windows
Make sure the [swig](http://www.swig.org/) executable is in your PATH. Add [libusb](http://libusb.info/)
and [ykpers](https://developers.yubico.com/yubikey-personalization/) DLLs to the root of the repository.
