...
==== Windows
Make sure the http://www.swig.org/[swig] executable is in your PATH. Add https://libusb.info/[libusb]
...
This project uses https://flake8.pycqa.org/[Flake8] for code style and https://github.com/PyCQA/bandit[Bandit] for security linting, used with a https://pre-commit.com/[pre-commit] hook.
