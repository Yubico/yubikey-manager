...
In order for the pip package to work [libu2f-host](https://developers.yubico.com/libu2f-host/), [ykpers](https://developers.yubico.com/yubikey-personalization/) and [libusb](http://libusb.info/) need to be installed on the system as well.
