...
class ManagementSession:
    ...
    def read_device_info_unchecked(self) -> dict[str, Any]: ...
...
class ClientPin:
    ...
    def close(self, session: Ctap2Session) -> None: ...

class ClientPinFido:
    def __init__(
        self,
        session: Ctap2FidoSession,
        protocol: PinProtocol | None = None,
    ) -> None: ...
    @property
    def protocol(self) -> PinProtocol: ...
    ...
    def close(self, session: Ctap2FidoSession) -> None: ...
