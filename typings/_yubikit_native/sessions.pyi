...
from yubikit.webauthn import ClientDataCollector, UserInteraction
...
class OpenPgpSession:
    ...
    def sign(
        self, message: bytes, hash_algorithm: int, prehash: int | None = None
    ) -> bytes: ...
...
class ManagementSessionOtp:
    def __init__(self, connection: OtpConnection) -> None: ...
    def close(self) -> None: ...
    @property
    def version(self) -> tuple[int, int, int]: ...
    @version.setter
...
class ManagementSessionFido:
    def __init__(self, connection: FidoConnection) -> None: ...
    def close(self) -> None: ...
    @property
    def version(self) -> tuple[int, int, int]: ...
    @version.setter
